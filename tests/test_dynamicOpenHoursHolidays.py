...
class TestDynamicOpenHoursHolidays(TestBase):
    ...
    def testDynamicOpenHoursDisplayNewYearsDay(self) -> None:
        self.setTimeAndAssertMatches(2024, 1, 1, 9, 59, matches=["Det är helgdag. Vi har stängt. Vi öppnar kl 10:00 på tisdag"])
    ...
    def testDynamicOpenHoursDisplayEpiphany(self) -> None:
        self.setTimeAndAssertMatches(2024, 1, 6, 9, 59, matches=["Det är helgdag. Vi har stängt. Vi öppnar kl 12:00 på söndag"])
    ...
    def testDynamicOpenHoursDisplayMayDay(self) -> None:
        self.setTimeAndAssertMatches(2024, 5, 1, 9, 59, matches=["Det är helgdag. Vi har stängt. Vi öppnar kl 10:00 på torsdag"])
    ...
    def testDynamicOpenHoursDisplayNationalDayOfSweden(self) -> None:
        self.setTimeAndAssertMatches(2024, 6, 6, 9, 59, matches=["Det är helgdag. Vi har stängt. Vi öppnar kl 10:00 på fredag"])
    ...
    def testDynamicOpenHoursDisplayChristmasEve(self) -> None:
        self.setTimeAndAssertMatches(2024, 12, 24, 9, 59, matches=["Det är helgdag. Vi har stängt. Vi öppnar kl 10:00 på fredag"])
        self.setTimeAndAssertMatches(2024, 12, 25, 9, 59, matches=["Det är helgdag. Vi har stängt. Vi öppnar kl 10:00 på fredag"])

    # Tests that the open hours are displayed on Christmas Day
    def testDynamicOpenHoursDisplayChristmasDay(self) -> None:
        self.setTimeAndAssertMatches(2024, 12, 25, 9, 59, matches=["Det är helgdag. Vi har stängt. Vi öppnar kl 10:00 på fredag"])
        self.setTimeAndAssertMatches(2024, 12, 26, 9, 59, matches=["Det är helgdag. Vi har stängt. Vi öppnar kl 10:00 på fredag"])
    ...
    def testDynamicOpenHoursDisplayNewYearsEve(self) -> None:
        self.setTimeAndAssertMatches(2024, 12, 31, 9, 59, matches=["Det är helgdag. Vi har stängt. Vi öppnar kl 10:00 på torsdag"])
        self.setTimeAndAssertMatches(2025, 1, 1, 9, 59, matches=["Det är helgdag. Vi har stängt. Vi öppnar kl 10:00 på torsdag"])
